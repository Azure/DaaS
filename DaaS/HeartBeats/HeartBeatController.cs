...
namespace DaaS.HeartBeats
{
    ...
    {
        public static readonly string StorageDirectory = Settings.Instance.UserSiteStorageDirectory;
    ...
    public static class HeartBeatController
    {
        ...
        {
            var heartBeatFiles = Directory.GetFiles(Path.Combine(HeartBeatConstants.StorageDirectory, HeartBeatConstants.HeartBeatFolder));
    ...
    public class HeartBeat
    {
        ...
        {
            return DateTime.UtcNow.AddSeconds(Infrastructure.Settings.HeartBeatLifeTimeInSeconds);
        }

        public void Send()
        {
            CreateHeartBeatDirectoryIfNotExists();
            var heartBeatPath = Path.Combine(HeartBeatConstants.StorageDirectory, GetHeartBeatRelativePath());
        ...
        {
            var heartBeatFolder = Path.Combine(HeartBeatConstants.StorageDirectory, HeartBeatConstants.HeartBeatFolder);
