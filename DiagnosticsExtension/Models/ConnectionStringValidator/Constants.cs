...
namespace DiagnosticsExtension.Models.ConnectionStringValidator
{
    public static class Constants
    {
        ...
        public const string ManagedIdentityClientIdNullOrEmptySummary = "The app setting {0}__clientId was expected but not found.";
        public const string ManagedIdentityClientIdNullOrEmptyDetails = "When the app setting {0}__credential is configured to \"managedidentity\", the clientId of a user assigned managed identity assigned to the Function App is expected in the app setting {0}__clientId.  Refer <a href='https://docs.microsoft.com/azure/azure-functions/functions-reference#common-properties-for-identity-based-connections' target='_blank'>here</a> for details. " + ManagedIdentityTutorial;
        ...
        public const string ClientIdInvalidTokenGeneratedSummary = "The ClientId configured in the app setting {0}__clientId does not match any user assigned managed identity assigned to this app.";
        ...
        public const string ManagedIdentityCredentialInvalidSummary = "The app setting {0}__credential is defined but not valid.  To configure user assigned managed identity, set it's value to \"managedidentity\".";
