...
namespace DiagnosticsExtension.Models.ConnectionStringValidator
{
    public static class Constants
    {
        ...
        public const string AuthFailureBlobStorageDocs = "See See <a href= 'https://docs.microsoft.com/azure/azure-functions/functions-bindings-storage-blob-trigger#connection-string' target='_blank'>relevant docs</a>.";
        public const string AuthFailureQueueStorageDocs = "See See <a href= 'https://docs.microsoft.com/azure/azure-functions/functions-bindings-storage-queue-trigger#connection-string' target='_blank'>relevant docs</a>.";
        public const string AuthFailureFileShareStorageDocs = "See See <a href= 'https://docs.microsoft.com/azure/storage/common/storage-account-keys-manage' target='_blank'>relevant docs</a>.";
        public const string AuthFailureServiceBusDocs = "See See <a href= 'https://docs.microsoft.com/azure/azure-functions/functions-bindings-service-bus-trigger#connection-string' target='_blank'>relevant docs</a>.";
        public const string AuthFailureEventHubsDocs = "See See <a href= 'https://docs.microsoft.com/azure/azure-functions/functions-bindings-event-hubs-trigger#connection-string' target='_blank'>relevant docs</a>.";
        ...
        public const string MalformedConnectionStringDetails = "The connection string configured in app setting {0} is invalid (e.g.missing some required elements).";
        public const string ManagedIdentityCredentialInvalidSummary = "The app setting {0}" + Credential + " is not valid.  To use identity based connections, set it's value to \"managedidentity\". See <a href='https://docs.microsoft.com/azure/azure-functions/functions-reference#common-properties-for-identity-based-connections' target='_blank'>relevant docs</a>. " + ManagedIdentityTutorial;
        public const string KeyVaultReferenceResolutionFailedSummary = "The Azure Key Vault reference configured in app setting {0} could not be resolved. See < a href='https://docs.microsoft.com/azure/app-service/app-service-key-vault-references' target='_blank'>relevant docs</a> to correct the issue.";
        #endregion
    }
}
