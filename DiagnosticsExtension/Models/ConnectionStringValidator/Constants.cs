...
namespace DiagnosticsExtension.Models.ConnectionStringValidator
{
    public static class Constants
    {
        ...
        public const string ConnectionInfoMissingSummary = "Necessary connection information was not found";
        ...
        public const string ServiceBusFQMissingDetails = "To connect to your service bus, you need to provide a connection string or use identity-based connections.  To learn more please refer <a href='https://docs.microsoft.com/azure/azure-functions/functions-bindings-service-bus-trigger#connections>' target='_blank'>here</a>. " + ManagedIdentityTutorial;
        public const string EventHubFQMissingDetails = "To connect to your event hub, you need to provide a connection string or use identity-based connections.  To learn more please refer <a href='https://docs.microsoft.com/azure/azure-functions/functions-bindings-event-hubs-trigger#connections>' target='_blank'>here</a>. " + ManagedIdentityTutorial;
        public const string FullyQualifiedNamespaceEmptySummary = "The app setting {0} has an empty value.";
        public const string BlobServiceUriEmptySummary = "The app setting {0} has an empty value.";
        public const string QueueServiceUriEmptySummary = "The app setting {0}__queueServiceUri has an empty value.";
        public const string ServiceUriEmptyDetails = "Refer <a href='https://docs.microsoft.com/azure/azure-functions/functions-bindings-storage-blob-trigger#identity-based-connections' target='_blank'>here</a> for relevant configuration details. " + ManagedIdentityTutorial;
        public const string ServiceBusFQNSEmptyDetails = "Refer <a href='https://docs.microsoft.com/azure/azure-functions/functions-bindings-service-bus-trigger#identity-based-connections' target='_blank'>here</a> for relevant configuration details. " + ManagedIdentityTutorial;
        public const string EventHubFQNSEmptyDetails = "Refer <a href='https://docs.microsoft.com/azure/azure-functions/functions-bindings-event-hubs-trigger#identity-based-connections' target='_blank'>here</a> for relevant configuration details. " + ManagedIdentityTutorial;
        ...
        public const string ManagedIdentityClientIdEmptySummary = "The app setting {0}" + ClientId + " has an empty value.";
        ...
        public const string StorageAccessRestrictedDetails = "This can be due to firewall rules on the resource.  Please check if you have configured firewall rules or a private endpoint and that they correctly allow access from the Function App.  Relevant documentation:<br><br><a href= 'https://docs.microsoft.com/en-us/azure/storage/common/storage-network-security?tabs=azure-portal' target='_blank'>Storage account network security</a>";
        ...
        public const string EventHubAccessRestrictedDetails = "This can be due to firewall rules on the resource.  Please check if you have configured firewall rules or a private endpoint and that they correctly allow access from the Function App.  Relevant documentation:<br><br><a href= 'https://docs.microsoft.com/en-us/azure/event-hubs/network-security' target='_blank'>Event Hubs network security</a>";
